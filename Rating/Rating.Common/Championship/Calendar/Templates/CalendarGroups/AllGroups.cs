namespace SecondMonitor.Rating.Common.Championship.Calendar.Templates.CalendarGroups
{
    ...
    public static class AllGroups
    {
        public static CalendarTemplateGroup MainGroup = new CalendarTemplateGroup("All", new[] {DtmGroup.AllDtmGroups, TCRGroups.AllTCRGroups, AudiTTGroup, AdacGTMasterCalendars.AllCalendars, DrmCalendars.AllCalendars, IndycarCalendars.AllIndyCar, Formula1Calendars.Formula1AllGroup,
            Formula2Calendars.Formula2AllGroup, Formula3Calendars.Formula3AllGroup, Formula4Calendars.Formula4AllGroup, ImsaCalendars.AllImsaCalendars}, Enumerable.Empty<CalendarTemplate>());
